...
Then you have to use the [multi binder](https://cloud.spring.io/spring-cloud-stream/reference/html/spring-cloud-stream.html#multiple-binders) facilities provided by Spring Cloud Stream.
