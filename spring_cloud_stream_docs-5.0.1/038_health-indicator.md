...
To enable health check you first need to enable both "web" and "actuator" by including its dependencies (see [Binding visualization and control](binding_visualization_control.html))
...
See [Connecting to Multiple Systems](multiple-systems.html) for details on how environment specific properties can be provided.
