...
This is because the underlying binder is built on top of [Reactor Kafka](https://projectreactor.io/docs/kafka/release/reference/)'s core API’s.
On the consumer side, it makes use of the [KafkaReceiver](https://projectreactor.io/docs/kafka/release/reference/#api-guide-receiver) which is a reactive implementation of a Kafka consumer.
Similarly, on the producer side, it uses [KafkaSender](https://projectreactor.io/docs/kafka/release/reference/#api-guide-sender) API which is the reactive implementation of a Kafka producer.
