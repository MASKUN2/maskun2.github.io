...
refer to the [kafka binder properties section](#kafka-binder-properties) for more information.
...
More details on how to suppress meters selectively can be found [here](https://micrometer.io/docs/concepts#_meter_filters).