...
See [this section](https://docs.spring.io/spring-cloud-stream/docs/current/reference/html/spring-cloud-stream.html#binding_visualization_control) from the reference docs for more details on this mechanism.
