...
as a `String` type (see [Content Type Negotiation](content-type.html#content_type_management) section), logs it to the console and sends it down stream after converting it to upper case.
