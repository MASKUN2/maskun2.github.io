...
Refer to the [Spring Retry](https://github.com/spring-projects/spring-retry) project for more information about the RetryTemplate, retry policies, backoff policies and more.